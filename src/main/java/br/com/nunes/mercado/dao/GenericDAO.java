...
import br.com.nunes.mercado.util.HibernateUtil;
...
public class GenericDAO<Entidade> {
	...
	@SuppressWarnings("unchecked")
	public List<Entidade> listarTipoDuplo(String campo, Character valor, String campo2, Character valor2) {
		Session sessao = HibernateUtil.getFabricaDeSessoes().openSession();
		try {
			Criteria consulta = sessao.createCriteria(classe);
			consulta.add(Restrictions.like(campo, valor));
	...
	@SuppressWarnings("unchecked")
	public List<Entidade> listarTiposDuplo(String campo, Character[] valor, String campo2, Character[] valor2) {
		Session sessao = HibernateUtil.getFabricaDeSessoes().openSession();
		try {
			Criteria consulta = sessao.createCriteria(classe);
			consulta.add(Restrictions.in(campo, valor));
	...
	@SuppressWarnings("unchecked")
	public List<Entidade> listarTipos3(String campo, Character[] valor, String campo2, Character[] valor2,
			String campo3, Character[] valor3) {
		Session sessao = HibernateUtil.getFabricaDeSessoes().openSession();
		try {
			Criteria consulta = sessao.createCriteria(classe);
			consulta.add(Restrictions.in(campo, valor));
